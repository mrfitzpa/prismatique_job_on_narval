...
``<root>/data/potential-slice-generator-output``, where ``<root>`` is the root
of the repository. 
...
path_to_repo_root = str(path_to_current_script.parent)
path_to_data_dir = path_to_repo_root + "/data"
...
# # :func:`prismatique.sample.generate_potential_slices` for a discussion on the
# # input parameters of said function, and the organization of the output files.
# output_dirname = path_to_data_dir + "/potential_slice_generator_output"
# worker_params = multislice_stem_sim_params.core_attrs["worker_params"]
...
for try_count in range(2):
    try:
        ...
        print(msg)
        print()
        script_to_execute = (path_to_repo_root
